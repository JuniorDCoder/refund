    ...
    <section class="py-12 bg-gray-50 sm:py-16 lg:py-20 xl:py-24">
        <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
            <div class="text-center">
                <p class="text-sm font-bold tracking-widest text-gray-700 uppercase">How It Works</p>
                <h2 class="mt-6 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl lg:text-5xl">Join us
                    in
                    4 easy steps
                </h2>
                <p class="max-w-2xl mx-auto mt-4 text-lg font-normal text-gray-700 lg:text-xl lg:leading-8">
                    Quick guide on how to join us and get our services.
                </p>
            </div>
            <ul class="grid max-w-md grid-cols-1 gap-10 mx-auto mt-12 sm:mt-16 lg:mt-20 lg:max-w-5xl lg:grid-cols-4">
                <li class="relative flex flex-start group lg:flex-col">
                    <span
                    ...
                    <div
                        class="inline-flex items-center justify-center w-10 h-10 transition-all duration-200 border border-gray-300 shrink-0 rounded-xl bg-gray-50 group-hover:border-gray-900 group-hover:bg-gray-900">
                    ...
                    <div class="ml-6 lg:ml-0 lg:mt-10">
                        ...
                        <h4 class="mt-2 text-base text-gray-700">To be an account holder you have to open an account first.</h4>
                    </div>
                </li>
                <li class="relative flex flex-start group lg:flex-col">
                    <span
                    ...
                    <div class="ml-6 lg:ml-0 lg:mt-10">
                        ...
                        <h4 class="mt-2 text-base text-gray-700">After registration you need to verify your Email</h4>
                    </div>
                </li>
                <li class="relative flex flex-start group lg:flex-col">
                    <span
                    ...
                    <div class="ml-6 lg:ml-0 lg:mt-10">
                        ...
                        <h4 class="mt-2 text-base text-gray-700">Deposit some funds before applying on any FDR or DPS plans.</h4>
                    </div>
                </li>
                <li class="relative flex flex-start group lg:flex-col">
                    <div
                    ...
                    <div class="ml-6 lg:ml-0 lg:mt-10">
                        ...
                        <h4 class="mt-2 text-base text-gray-700">Now you can get any of our services as our registered account-holder</h4>
                    </div>
                </li>
            </ul>
        </div>
