            ...
            <div class="grid grid-cols-2 gap-3 py-10 sm:grid-cols-4 lg:grid-cols-6 md:gap-8 max-sm:max-w-sm max-sm:mx-auto gap-y-8">
                ...
                <div class="text-left lg:mx-auto ">
                    ...
                    <ul class="text-sm transition-all duration-500">
                        ...
                        <li class="mb-6"><Link :href="route('welcome')"  class="text-gray-600 hover:text-gray-900">Pricing</Link></li>
                        <li><Link :href="route('welcome')"  class="text-gray-600 hover:text-gray-900">Features</Link></li>
                    </ul>
                </div>
                <!--End Col-->
                <div class="text-left lg:mx-auto ">
